...
import { schedulerSidebarVisibleAtom, toggleSchedulerSidebarAtom } from "../atoms/sidebarState"
...
const SchedulerSidebar = ({ onNewEvent }: Props) => {
  const [isVisible] = useAtom(schedulerSidebarVisibleAtom)
  const toggleSidebar = useSetAtom(toggleSchedulerSidebarAtom)
