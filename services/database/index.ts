...
interface DatabaseOperations {
  ...
  // Event operations
  getAllEvents(options?: DatabaseOptions): Promise<typeof schema.events.$inferSelect[]>;
  getChatEvents(chatId: string, options?: DatabaseOptions): Promise<typeof schema.events.$inferSelect[]>;
  getActiveChatEvents(chatId: string, options?: DatabaseOptions): Promise<typeof schema.events.$inferSelect[]>;
  getEvent(eventId: number, options?: DatabaseOptions): Promise<typeof schema.events.$inferSelect>;
  createEvent(data: NewEvent, options?: DatabaseOptions): Promise<typeof schema.events.$inferSelect>;
  deleteEvent(eventId: number, options?: DatabaseOptions): Promise<void>;
  setEventActive(eventId: number, active: boolean, options?: DatabaseOptions): Promise<typeof schema.events.$inferSelect>;
}
...
class DirectDatabaseAccess implements DatabaseOperations {
  ...
  async getChatEvents(chatId: string, _options?: DatabaseOptions) {
    return await this.db.query.events.findMany({
  ...
  async getActiveChatEvents(chatId: string, _options?: DatabaseOptions) {
    return await this.db.query.events.findMany({
      where: and(
  ...
  async getEvent(eventId: number, _options?: DatabaseOptions) {
  ...
  async createEvent(data: NewEvent, _options?: DatabaseOptions) {
    const chatExists = await this.checkChatExists(data.chatId);
    if (!chatExists) {
  ...
  async deleteEvent(eventId: number, _options?: DatabaseOptions) {
    await this.db.delete(events).where(eq(events.id, eventId));
  }

  async setEventActive(eventId: number, active: boolean, _options?: DatabaseOptions) {
    const [event] = await this.db
      .update(events)
      .set({ isActive: active })
      .where(eq(events.id, eventId))
...
// Database operations interface implementation check
interface DatabaseOperations {
  MODE: DatabaseMode;
  db: BetterSQLite3Database<typeof schema>;
  getAllChats(options?: DatabaseOptions): Promise<(typeof schema.chats.$inferSelect)[]>;
...
// Event operations
export const getAllEvents = (options?: DatabaseOptions) => databaseOperations.getAllEvents(options);
export const getChatEvents = (chatId: string, options?: DatabaseOptions) =>
  databaseOperations.getChatEvents(chatId, options);
export const getActiveChatEvents = (chatId: string, options?: DatabaseOptions) =>
  databaseOperations.getActiveChatEvents(chatId, options);
export const getEvent = (eventId: number, options?: DatabaseOptions) =>
  databaseOperations.getEvent(eventId, options);
export const createEvent = (data: NewEvent, options?: DatabaseOptions) =>
  databaseOperations.createEvent(data, options);
export const deleteEvent = (eventId: number, options?: DatabaseOptions) =>
  databaseOperations.deleteEvent(eventId, options);
export const setEventActive = (eventId: number, active: boolean, options?: DatabaseOptions) =>
  databaseOperations.setEventActive(eventId, active, options);
